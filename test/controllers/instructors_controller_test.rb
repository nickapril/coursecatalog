...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { comment: @instructor.comment, email: @instructor.email, first_name: @instructor.first_name, last_name: @instructor.last_name, official_id: @instructor.official_id } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { comment: @instructor.comment, email: @instructor.email, first_name: @instructor.first_name, last_name: @instructor.last_name, official_id: @instructor.official_id } }
